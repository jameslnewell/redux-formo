    ...
    class DecoratedForm extends React.Component {
        ...
        this.handlers = Object.assign.apply(null, fieldNames.map(fieldName => {
          return {[fieldName]: {
            ...
            onBlur: () => {
              ...
              if (validateOnBlur) props.actions.validate(validate, fieldName, fieldValues);
            },
      ...
      handleSubmit(event) {
        ...
        let
          props = this.props,
          valid = true,
          fieldValues = getValue(props.fields, initialFieldValues);
        ;
        ...
        fieldNames.forEach(fieldName => {
          ...
          if (validateOnSubmit) valid = props.actions.validate(validate, fieldName, fieldValues) && valid;
