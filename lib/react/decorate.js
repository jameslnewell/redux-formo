    ...
    class DecoratedForm extends React.Component {
        ...
        this.handlers = Object.assign.apply(null, fieldNames.map(fieldName => {
          return {[fieldName]: {
            ...
            onBlur: () => {
              ...
              let fieldValues = getValues(this.props.form.fields, initialFieldValues);

              if (filterOnBlur) {
                props.form.actions.filter(filter, fieldName, fieldValues);
              }
      ...
      handleSubmit(event) {
        ...
        let
          props = this.props,
          valid = true,
          fieldValues = getValues(props.form.fields, initialFieldValues);
        ;
       ...
       */
      render() {
        let {form: {fields}, ...props} = this.props;
